      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-12 gap-4 place-content-center mt-4">
          ...
          <div className="col-start-4 col-end-10 grid grid-cols-4">
            {/* left-info*/}
            {/* name & sprites */}
            <div className="col-start-1 col-end-4 flex flex-col justify-center items-center space-y-4">
              {/* name */}
              <section>
            ...
            <div className="col-start-4 col-end-5 flex flex-col space-y-4">
              <div className="flex space-x-2 w-full h-1/2 items-center justify-center border rounded">
          ...
          {/* abilities */}
          <div className="col-start-4 col-end-10 flex flex-col border">
            {/* title */}
            <div className="flex">
            ...
            <div className="flex items-center space-x-2">
              <SiTarget />
              <span className="text-lg">Ability A</span>
            </div>
          </div>
        </div>
      )}
